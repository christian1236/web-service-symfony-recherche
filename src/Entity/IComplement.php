...
use App\Repository\IComplementRepository;
use Doctrine\ORM\Mapping as ORM;

/**
 * IComplement
 *
 * @ORM\Table(name="I_Complement", indexes={@ORM\Index(name="idx_email_valeur", columns={"email_valeur"}), @ORM\Index(name="idx_fix2_valeur", columns={"Fix2_valeur"}), @ORM\Index(name="idx_fix_valeur", columns={"Fix_valeur"}), @ORM\Index(name="idx_portable_valeur", columns={"portable_valeur"})})
 * @ORM\Entity
 * 
 *
 * @ApiResource()
 * @ORM\Entity(repositoryClass=IComplementRepository::class)
 *
 */
class IComplement
{
     ...
     * @var string
     *
     * @ORM\Column(name="dnaiss", type="string", length=12, nullable=false)
     */
    private $dnaiss;
    ...
    public function getDnaiss(): ?string
    {
        return $this->dnaiss;
    }

    public function setDnaiss(string $dnaiss): self
    {
        $this->dnaiss = $dnaiss;
